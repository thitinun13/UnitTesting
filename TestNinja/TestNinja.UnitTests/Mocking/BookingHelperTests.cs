...
namespace TestNinja.UnitTests.Mocking
{
    ...
    public class BookingHelper_OverlappingBookingsExistTests
    {
        ...
        [Test]
        public void BookingStartsBeforeAndFinishesInishesInTheMaiddleOfAnExistingBooking_ReturnExistingBookingsReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingStartsInTheMiddleOfAfterAnExistingBookingButFinishAfter_ReturnExistingBookingsReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
