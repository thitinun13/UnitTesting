...
namespace TestNinja.UnitTests.Mocking
{
    ...
    public class HouseKeeperServiceTests
    {
        ...
        var service = new HousekeeperSevice(
        unitOfWork.Object,
        statementGenerator.Object,
        emailSender.Object,
        messageBox.Object);

        Service.SendStamentEmails(new DateTime(2017, 1, 1));

        statementGenerator.Verify(Sg => Sg.SaveStatment(1, "b", (new DateTime(2017, 1, 1)));
